...
@section('content')
    <div class="page-header">
        ...
        @authorized('Movie', 'CREATE')
        <a href="{{ route('movies.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
        @endauthorized
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('movie_data') }}">
